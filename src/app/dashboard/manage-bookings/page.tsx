import { ManageBookingsPage } from '@prometora/marketplace-ui';

/**
 * Manage Bookings Page (Seller)
 * Wrapper page that uses the ManageBookingsPage component from @prometora/marketplace-ui
 */
export default function ManageBookings() {
  ...
  return <ManageBookingsPage storeSlug={storeSlug} apiUrl={apiUrl} />;
}
