import { DashboardPage } from '@prometora/marketplace-ui';

/**
 * Dashboard Page
 * Wrapper page that uses the DashboardPage component from @prometora/marketplace-ui
 */
export default function Dashboard() {
  ...
  return <DashboardPage storeSlug={storeSlug} apiUrl={apiUrl} />;
}
