import { MessagesPage } from '@prometora/marketplace-ui';

/**
 * Messages Page
 * Wrapper page that uses the MessagesPage component from @prometora/marketplace-ui
 */
export default function Messages() {
  ...
  return <MessagesPage storeSlug={storeSlug} apiUrl={apiUrl} />;
}
